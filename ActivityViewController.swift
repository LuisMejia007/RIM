...
class ActivityViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func fetchInfo()
    {
        ...
        databaseHandle = ref.observe(DataEventType.value, with: { (snapshot) in
            ...
            for information in snapshot.children.allObjects as! [DataSnapshot]
            {
                ...
                let activity = ActivityFeed(username:username, company:company, profileImageUrl:profileImageUrl, timeStamp:timeStamp, userPic:profileImageUrl, priority:priority)
    ...
    {
        performSegue(withIdentifier: "showActivity", sender: self)  //segue to new controller
    }
